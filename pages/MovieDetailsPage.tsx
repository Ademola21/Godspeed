            ...
            <div className="md:w-1/3 flex-shrink-0">
                <img 
                  ...
                  onError={(e) => {
                    ...
                    fallback.className = 'w-full h-96 bg-gray-700 rounded-lg shadow-2xl flex items-center justify-center text-gray-400';
                    fallback.innerHTML = `<div class="text-center"><div class="text-6xl mb-4">🎬</div><div class="text-xl">${movie.title}</div></div>`;
